...
import { SlicerSettingComponent } from 'app/entities/slicer-setting/slicer-setting.component';
...
describe('Component Tests', () => {
  describe('SlicerSetting Management Component', () => {
    let comp: SlicerSettingComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SlicerSettingComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.slicerSettings && comp.slicerSettings[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
