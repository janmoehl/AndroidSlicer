...
/**
 * Performance test for the Slice entity.
 */
class SliceGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Slice entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created slice")
                .get("${new_slice_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created slice")
            .delete("${new_slice_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
