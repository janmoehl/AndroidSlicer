...
public class SliceResourceIT {
    ...
    public static Slice createUpdatedEntity() {
        Slice slice = new Slice()
            ...
            .trackingToSlicingCriterion(UPDATED_TRACKING_TO_SLICING_CRITERION);
        return slice;
    }
    ...
    @Test
    public void getAllSlices() throws Exception {
    ...
    public void updateSlice() throws Exception {
        ...
        restSliceMockMvc.perform(put("/api/slices")
            .contentType(MediaType.APPLICATION_JSON)
        ...
        assertThat(testSlice.isTrackingToSlicingCriterion()).isEqualTo(UPDATED_TRACKING_TO_SLICING_CRITERION);
    }
